        ...
        <div className="-my-10">
          <div className="flex space-x-4 text-sm text-slate-500">
            ...
            <div className="flex-1 py-10">
              <h3 className="font-medium text-slate-900">Emily Selman</h3>
              <p>
                <time dateTime="2021-07-16">July 16, 2021</time>
              </p>
              <div className="mt-4 flex items-center">
                {/* Active: "text-slate-400", Default: "text-slate-300" */}
                <svg
                  className="text-slate-400 h-5 w-5 flex-shrink-0"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  aria-hidden="true"
                >
              ...
              <div className="prose prose-sm mt-4 max-w-none text-slate-500">
                <p>
          ...
          <div className="flex space-x-4 text-sm text-slate-500">
            ...
            <div className="flex-1 py-10 border-t border-slate-200">
              <h3 className="font-medium text-slate-900">Hector Gibbons</h3>
              <p>
              ...
              <div className="prose prose-sm mt-4 max-w-none text-slate-500">
                <p>
                  ...
                  so consistent and each SVG is optimized out of the box so I
                  can use it directly with confidence. It would take me several
                  hours to create a single icon this good, so it's a steal at
                  this price.
                </p>
              </div>
            </div>
